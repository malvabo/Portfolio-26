    ...
    <section className="pt-32 pb-5 lg:pt-40 lg:pb-5 container mx-auto px-8 lg:px-12 relative">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-8">
          ...
          <div className="w-full max-w-[520px] mt-[20px] relative z-30">
            <p className="hero-reveal hero-reveal-2 font-serif text-[32px] font-normal leading-relaxed tracking-[-0.02em] text-foreground relative z-10">
