...
export const metadata: Metadata = {
  ...
  description: 'Starting from a blank slate, with no problem statement and no defined scope, and exploring how AI could surface actionable intelligence inside the platform 50,000+ sellers already lived in.',
  openGraph: {
