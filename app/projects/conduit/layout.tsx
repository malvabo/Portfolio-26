...
export const metadata: Metadata = {
  ...
  description: 'Every food shipment crossing a border needs a stack of certificates and forms, redone by hand each time. Conduit reads those documents and fills the forms, using the fields each customer sets up.',
  openGraph: {
